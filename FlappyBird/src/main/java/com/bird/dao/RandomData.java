...
public class RandomData {
    ...
    //返回中文姓名，并设置性别
  //  public static String name_sex = "";//定义性别字符串


    public static String getChineseName() {     //获得名字
        //产生随机姓氏
    ...
    public static  int gettime (){ //随机生成时间记录
        Random r=new Random();
        int time=r.nextInt(10,100);
        return time;
    }

    public static void main(String[] args) {
        for (int i = 0; i < 5; i++) {
            System.out.println(getChineseName()+"\t"+gettime()+"秒");
        }
    }
}
